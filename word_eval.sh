...
python3 lm_code/word_evaluation_saycam.py \
        ...
        --examples_file="/ext3/multimodal-baby/data/saycam_val_text.txt" \
        --min_samples=3 \
        --max_samples=512 \
        --batch_size=128 \
        --output_file=${CHECKPOINT_DIR}/surprisals.txt \
        --model_dir=${CHECKPOINT_DIR} \
        --model_type="lstm_saycam" \
        --save_samples="/ext3/multimodal-baby/data/saycam_val_samples_updated.pkl" \
        --min_seq_len=5
